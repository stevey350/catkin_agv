...
{ 
    ...
    //struct canfd_frame frame;
    struct ifreq ifr;
    struct can_filter *rfilter = new  (struct can_filter[filtCnt]);   // 接收过滤 warming: filtCnt isn't a constant
...
//    sendfram.can_id &= CAN_SFF_MASK;
    sendfram.can_id = id&CAN_SFF_MASK;
...
// In singular thread, it receive data from can_id with noblock.
// param: <buf_ptr> <m_recv_datecounter>
// maintained by ssj
